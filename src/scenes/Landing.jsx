            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                >
                    ...
                    <p className="mt-10 mb-7 text-sm text-center md:text-start">
                        I'm a Software Engineering student graduate from Western University, previously interning at RBC and Equestrian Show Manager.                             
                    </p>
                </motion.div>
                ...
                >
                    <AnchorLink
                        className="bg-gradient-rainblue text-deep-blue rounded-sm py-3 px-7 font-semibold hover:bg-blue
                            hover:text-white tranisition duration-500"
